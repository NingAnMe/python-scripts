...
# HDF5 文件路径
IN_PATH = '/nas03/CMA_GSICS_TEST/Pics/SupportData/PreprocessingData/FY1D+MVISR/3_L2'
...
# 输出路径
OUT_PATH = '/nas03/CMA_GSICS_TEST/Pics/SupportData/ExtractTXT/FY1D+MVISR/3_L3'
# 输出文件名
OUT_FILE_NAME = 'FY1D+MVISR_{}_lon{:+08.3f}_lat{:+08.3f}_{}x{}.txt'
